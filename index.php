			...
			<div class="banner-content">
				<div class="banner-message">
					<div class="banner-entry">
						<span class="entry-title">Society Management System</span>
						<span class="entry-message">managed by PCE</span>
					</div>
				</div>
			</div>
		</div>
						...
						<ul class="reviews-listing">
							<li>
								<div class="descr">
									...
									<p>Register your society with us to manage and maintain all the important details and information in one place.</p>
								</div>
							</li>
							<li>
								<div class="descr">
									<span class="title">Login with given society code</span>
									<p> Login to your society's personalized dashboard using your unique society code to access all the features and functionalities.</p>
								</div>
							</li>
							<li>
								<div class="descr">
									<span class="title">Share society code with all society members</span>
									<p>Share your society code with all the society members to give them access to the society's information and updates.</p>
								</div>
							</li>
							<li>
								<div class="descr">
									<span class="title">Set committee members</span>
									<p>Assign and manage committee members for different roles and responsibilities to streamline the decision-making process and ensure effective functioning of the society.</p>
								</div>
							</li>
							<li>
								<div class="descr">
									<span class="title">Set workers</span>
									<p>Hire and manage workers for various tasks and responsibilities within the society.</p>
								</div>
							</li>
							<li>
								<div class="descr">
									<span class="title">Maintain Society</span>
									<p>Keep track of society expenses, payments, and other important details to ensure proper maintenance and smooth functioning of the society.
