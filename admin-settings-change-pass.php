<?php 
	...
	if (isset($_POST['Change'])) {
		require('db-admin-change-pass.php');
	}
					...
					<div class="col-md-8 col-md-offset-2 col-sm-12">
						<div class="office-contact-form">
							...
							<div class="contact-form">
								<form method="post" action="admin-settings-change-pass.php" autocomplete="autocomplete">
									<input type="text" class="form-control" placeholder="Society_Code *"  name="sc" required="required">
									<input type="password" class="form-control" placeholder="Old Password *"  name="op" required="required"><br>
